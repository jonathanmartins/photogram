...
feature 'editing user profiles' do
  background do
    user = create :user
    user_two = create :user, email: "email2@email.com", username: 'user2'
  ...
  scenario 'a user can change their own profile details' do
    ...
    attach_file 'user_avatar', 'spec/files/images/cat.jpg'
  ...
  scenario "a user cannot navigate directly to edit a users profile" do
    ...
    expect(page).to have_content "That profiel doesn't belongs to you"
  end
end
